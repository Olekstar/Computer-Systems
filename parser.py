...
class TokenType:
    # Оновлено список токенів, додавши нові типи
    INTEGER = "INTEGER"
    PLUS = "PLUS"
    MINUS = "MINUS"
    MUL = "MUL"
...
class Parser:
    ...
    def factor(self):
        """Фактор може бути цілим числом або виразом у дужках."""
    ...
    def expr(self):
        """Включаємо підтримку додавання і віднімання."""
        node = self.term()
